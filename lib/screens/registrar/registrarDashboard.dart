  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Register a Student here'),
        actions: [
          Padding(
                  ...
                  children: <Widget>[
                    ...
                    TextFormField(
                      ...
                      validator: (value) {
                        ...
                        if (!RegExp(r'^[A-Z]{3}_\d{4}_\d{2}$')
                            .hasMatch(value)) {
                          return 'Invalid ID format. Please enter in the format: AAA_0000_00';
                        }
                        return null;
                      },
                    ),
                    ...
                    if (_college ==
                      ...
                      Column(
                        children: [
                          ...
                          ListTile(
                            title:
                                const Text('English Language and Literature'),
                            leading: Radio<String>(
                          ...
                          ListTile(
                            title:
                                const Text('Ethiopian Language and Literature'),
                            leading: Radio<String>(
                          ...
                          ListTile(
                            title:
                                const Text('History and Heritage Management'),
                            leading: Radio<String>(
...
//after the radio button is selected make it rollback
                    ...
                    TextFormField(
                      ...
                      validator: (value) {
                        ...
                        if (gpa == null) {
                          _showErrorMessage(
                              context, 'Please enter a valid GPA');
                        ...
                        onPressed: () async {
                          if (_formKey.currentState!.validate()) {
                            ...
                            try {
                              ...
                              // After sign up, navigate to the dashboard page
                              showDialog(
                                context: context,
